...
// console.log(getAverageAge(arr)); // 27.6667
...
// console.log(checkPalindrome(string)); // Anna is a palindrome.
...
// let bestColors = ['green', 'blue', 'red', 'purple', 'black'];
...
// const sister = 'Bim Promsawad';

// const swapNames = 

// console.log(swapNames(sister)); // 'Promsawad Bim'
...
// let arr = [42,54,65,87,0];

// const min = 
// const max = 

// console.log(min(arr), max(arr)); // 0 87
...
//     if(((playerChoice === 'rock') && (botChoice === 'scissors')) || ((playerChoice === 'paper') && 
//     (botChoice === 'rock')) || ((playerChoice === 'scissors') && (botChoice === 'paper'))){
//         return 'You win!'
...
// console.log(convertToNum(string), convert(string2)) // 1234 605
...
// let string = 'Let your goal be a conjuring of who you want to be';
...
// console.log(positiveSum(array)); // 20
...
// console.log(arrayPlusArray(arrA,arrB)); // 33
...
// let letsDance = ["I", "study", "JavaScript", "right", "now"];
...
// let array = ['You', 'are', 'doing', 'great', 'yes', 'you', 'are']; // findIndex
...
// console.log(fixTheMeerkat(meerkat)); // ['head', 'body', 'tail']
...
// console.log(arrayMax(values)); // 11
...
// console.log(arr); // use negative indexes
...
// // after the call -> use console to check menu object property values
// menu = {
//   width: 400,
//   height: 600,
//   title: "My menu"
